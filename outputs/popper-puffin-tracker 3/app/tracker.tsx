...
export default function Tracker() {
  ...
  useEffect(() => {
    ...
    }); return () => { active = false; mapMarker.current?.remove(); northPoleMarker.current?.remove(); mapObject.current?.remove(); };
